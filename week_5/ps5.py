...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        keyaz = list(string.ascii_lowercase)
        valueaz = list(string.ascii_lowercase)
        shiftaz = valueaz[shift:] + valueaz[:shift]
        
        keyAZ = list(string.ascii_uppercase)
        valueAZ = list(string.ascii_uppercase)
        shiftAZ = valueAZ[shift:] + valueAZ[:shift]

        keyazAZ = keyaz + keyAZ
        valueazAZ = shiftaz + shiftAZ
        
        self.shift_dict = dict(zip(keyazAZ, valueazAZ))    #dictionary compresion
